...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="brand-add.php" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM tbl_brands ORDER BY brand_id DESC");
            	$statement->execute();
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Warning: All models under this brand will also be deleted.</p>
            </div>
