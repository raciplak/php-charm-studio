                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="address-card">
                                <h4 class="address-title"><?php echo LANG_VALUE_161; ?></h4>
                                <div class="address-grid">
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_102; ?></label>
                                        <span><?php echo $_SESSION['customer']['cust_b_name']; ?></span>
                                    </div>
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_103; ?></label>
                                        <span><?php echo $_SESSION['customer']['cust_b_cname']; ?></span>
                                    </div>
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_104; ?></label>
                                        <span><?php echo $_SESSION['customer']['cust_b_phone']; ?></span>
                                    </div>
                                    <div class="address-item">
                                    ...
                                    <div class="address-item full-width">
                                        ...
                                        <span><?php echo nl2br($_SESSION['customer']['cust_b_address']); ?></span>
                                    </div>
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_107; ?></label>
                                        <span><?php echo $_SESSION['customer']['cust_b_city']; ?></span>
                                    </div>
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_108; ?></label>
                                        <span><?php echo $_SESSION['customer']['cust_b_state']; ?></span>
                                    </div>
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_109; ?></label>
                                        <span><?php echo $_SESSION['customer']['cust_b_zip']; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="address-card">
                                <h4 class="address-title"><?php echo LANG_VALUE_162; ?></h4>
                                <div class="address-grid">
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_102; ?></label>
                                        <span><?php echo $_SESSION['customer']['cust_s_name']; ?></span>
                                    </div>
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_103; ?></label>
                                        <span><?php echo $_SESSION['customer']['cust_s_cname']; ?></span>
                                    </div>
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_104; ?></label>
                                        <span><?php echo $_SESSION['customer']['cust_s_phone']; ?></span>
                                    </div>
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_106; ?></label>
                                        <span>
                                    ...
                                    <div class="address-item full-width">
                                        <label><?php echo LANG_VALUE_105; ?></label>
                                        <span><?php echo nl2br($_SESSION['customer']['cust_s_address']); ?></span>
                                    </div>
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_107; ?></label>
                                        <span><?php echo $_SESSION['customer']['cust_s_city']; ?></span>
                                    </div>
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_108; ?></label>
                                        <span><?php echo $_SESSION['customer']['cust_s_state']; ?></span>
                                    </div>
                                    <div class="address-item">
                                        <label><?php echo LANG_VALUE_109; ?></label>
                                        <span><?php echo $_SESSION['customer']['cust_s_zip']; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
