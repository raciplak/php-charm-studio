...
<?php
// Cart data (shared between desktop and mobile)
$header_cart_count = 0;
$header_cart_total = 0;
		...
		<div class="row">
			<div class="col-md-12 pl_0 pr_0">
				<div class="menu-container">
					<!-- Hamburger Toggle Button (used by mobile slide menu) -->
					...
					<div class="menu">
						<ul>
							...
							<?php
							// Show Brands with show_on_menu=1 as top-level menu items with their models as sub-items
							...
							<?php
							// Show Models with show_on_menu=1 as INDEPENDENT top-level menu items (like brands)
							// Exclude models whose brand already has show_on_menu=1 (they are already shown above)
